...
namespace SnowBound.Weather
{
    ...
    public class WeatherSystem : MonoBehaviour
    {
        ...
        /// <summary>
        /// The weather no longer lights the scene. LightingDirector does that,
        /// from this system's storminess and the clock's sun — one place that
        /// owns the look, rather than two that have to agree.
        /// </summary>
        void Apply()
        {
        }
